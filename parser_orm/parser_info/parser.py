from .functions import get_html, save_json, prepare_group_info, get_from_name_joined, get_from_name, prepare_video_info, get_htmls
...
def final_result_info(path):
    ...
    for i in fname_list:
        ...
        result_2 = prepare_video_info(video_dict)
        channel_content = result[0]
        channel_content_list.append(channel_content)
        group_video_list.append(result_2)
        group_content_list.append(ready_information)
    return [channel_content_list, group_content_list, group_video_list]

# final_result_info('E:\SmartTech Learning Group\\2021')
